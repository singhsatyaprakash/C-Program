/*Read details of N students of a class such as Std_Id, Name, Course and Marks in three subjects S1,S2 and S3 along with the Std_Id to be searched in the main program.Assume Std_Id is the unique field. Design a UDF to display the details along with the percentage marks to the console. Assume maximum marks 100 per subject. */
#include <stdio.h>
...
Enter the student id: 230112058
Enter name of student: SATYA
Enter course of student: BCA
MARKS:
Subject1: 89
Subject2: 78  
Subject3: 94
Enter the student id: 230012087
Enter name of student: DEEPAK
Enter course of student: MCA
MARKS:
Subject1: 98
Subject2: 87
Subject3: 89
Enter a student id to be searched: 230112058
The details are:
Std-ID: 230112058
Name: SATYA
Subject1: 89
